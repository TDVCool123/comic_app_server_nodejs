...
class Crawler {
    static buildUrl(type, page) {
        ...
        (0, util_1.log)(`GET ${url}`);
        return url;
    }
    static async newestComics(page) {
        const body = await (0, util_1.GET)(Crawler.buildUrl('newest', page));
        return (0, util_1.bodyToComicListNew)(body);
    }
    static async updatedComics(page) {
        const body = await (0, util_1.GET)(Crawler.buildUrl('latest', page));
        return (0, util_1.bodyToComicListNew)(body);
    }
    static async mostViewedComics(page) {
        const body = await (0, util_1.GET)(Crawler.buildUrl('topview', page));
        return (0, util_1.bodyToComicListNew)(body);
    }
}
